...
function User() {
	...
	//Checar url válida para o site do usuário
	...
	return (
		<>
			<div className="w-full mx-auto lg:w-10/12">
				...
				<div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8">
					...
					<div className="col-span-2">
						...
						<div className="w-full rounded-lg shadow-md bg-base-100 stats">
							{location && (
								<div className="stat">
									<div className="stat-title text-md">Localização</div>
							...
							{twitter_username && (
								<div className="stat">
									...
									<div className="text-lg stat-value">
										<a href={`https://x.com/${twitter_username}`} target="_blank" rel="noreferrer">
											{twitter_username}
										</a>
									</div>
								</div>
				...
				<div className="w-full py-5 mb-6 rounded-lx shadow-md bg-base-100 stats">
					<div className="stat">
					...
					<div className="stat">
						...
						<div className="stat-title pr-5">Seguindo</div>
